...
int indexForBase(char a)
{
  switch(a)
  {
    ...
    case 'i': case 'I' :
      return 9;
    case 'l': case 'L' : case 'o' : case 'O' : case 'j' : case 'J' :
      return 10;
    case 'k': case 'K' :
      return 11;
    case 'm': case 'M' :
...
ScoringMatrix getMatrixFromFile(char* filename)
{
  ...
  if(inputFile)
  {
    ...
    {
      if(sscanf(line,"%c %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d",&ch,&a,&b,&c,&d,&e,&f,&g,&h,&i,&j,&k,&l,&m,&n,&o,&p,&q,&r,&s,&t,&u,&v,&w,&x) == 25)
      {
